		...
		<header>
			<nav class="nav-extended indigo">
				<div class="nav-wrapper">
					<a href="<?=WEBROOT?>" class="brand-logo center light">The bet-Line</a>
					<a href="#" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">menu</i></a>
					<ul id="nav-mobile" class="right hide-on-med-and-down">
						<li><a href="<?=WEBROOT?>user/display_event">Les Matchs</a></li>
						<li><a href="<?= WEBROOT?>user/profile">Mon profil</a></li>
						<li><a href="<?= WEBROOT?>user/display_market">Acheter des jetons</a></li>
						<?
							if ($_SESSION["role"] === "1" || $_SESSION["role"] === "2") {
								echo "<li><a href=\"" . WEBROOT . "admin/display_pannel\">Admin</a></li>";
							}
						?>
					</ul>
